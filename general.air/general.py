...
try:
    ...
    poco("com.thinkhome.v3:id/item_vibration_feedback").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
...
try:
    ...
    poco("com.thinkhome.v3:id/item_audio_feedback").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
...
try:
    ...
    poco("com.thinkhome.v3:id/item_voice_control").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
...
#房间头部：开启首页设置
try:
    poco("android:id/tabs").child("android.widget.RelativeLayout")[1].child("com.thinkhome.v3:id/tab_image").click()
    ...
    login()
    sleep(2)
    resultScenario = poco("android:id/tabs").child("android.widget.RelativeLayout")[1].child("com.thinkhome.v3:id/tab_text").get_text()
...
try:
    ...
    sleep(2)
    snapshot(msg="设置前")
    poco("com.thinkhome.v3:id/pwd_app").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
    poco("com.thinkhome.v3:id/pwd_system").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
    poco("com.thinkhome.v3:id/pwd_single_item").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
    poco("com.thinkhome.v3:id/device_list").child("android.widget.LinearLayout")[1].child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
    sleep(2)
    snapshot(msg="设置后")
except:
    print("Error!")
    ...
    poco("com.thinkhome.v3:id/pwd_single_item").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
    snapshot(msg="设置后")
    poco("com.thinkhome.v3:id/pwd_all").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/switch_view").click()
...
try:
    ...
    sleep(5)
    poco("com.thinkhome.v3:id/recycler_view").child("android.widget.LinearLayout")[0].child("com.thinkhome.v3:id/grid_view").child("android.widget.LinearLayout")[2].child("com.thinkhome.v3:id/image_view").click()
...
try:
    ...
    poco(text="模版").click()
    sleep(2)
    poco("com.thinkhome.v3:id/recycler_view").child("android.widget.LinearLayout")[2].child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/grid_view").child("android.widget.LinearLayout").child("com.thinkhome.v3:id/image_view").click()
    sleep(1)
    poco("com.thinkhome.v3:id/toolbar_right_text").click()
    #poco(text="测试1").click()
    poco("com.thinkhome.v3:id/list_view").child("android.widget.RelativeLayout")[3].child("android.widget.LinearLayout")[0].child("com.thinkhome.v3:id/tv_device_name").click()
    sleep(1)
    poco(text="1").click()
    poco("android:id/button1").click()
    poco("com.thinkhome.v3:id/list_view").child("android.widget.RelativeLayout")[1].child("android.widget.LinearLayout")[0].child("com.thinkhome.v3:id/tv_device_name").click()
    sleep(1)
    poco(text="2").click()
    poco("android:id/button1").click()
    poco("com.thinkhome.v3:id/list_view").child("android.widget.RelativeLayout")[2].child("android.widget.LinearLayout")[0].child("com.thinkhome.v3:id/tv_device_name").click()
    sleep(1)
    poco(text="2").click()
    poco(text="3").click()
    poco("android:id/button1").click()
...
try:
    ...
    poco("com.thinkhome.v3:id/grid_view").child("android.widget.RelativeLayout")[0].child("com.thinkhome.v3:id/image").click()
    poco("com.thinkhome.v3:id/toolbar_btn_setting").click()
    poco(text="从相册选择").click()
