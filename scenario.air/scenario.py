...
try:
    while poco("com.thinkhome.v3:id/listView").exists():
        poco("com.thinkhome.v3:id/listView").child("com.thinkhome.v3:id/item_layout")[0].long_click()
        poco(text="删除").click()
        if poco("com.thinkhome.v3:id/et_password").exists():
            doInputPassword() 
        sleep(2)
...
try:
    #正确添加
    addLinkageCombination = poco("com.thinkhome.v3:id/xlistView").child("android.widget.RelativeLayout")[0].child("com.thinkhome.v3:id/item_add_device_lv").child("com.thinkhome.v3:id/tv_device_text").get_text()
...
try:
    ...
    if poco("com.thinkhome.v3:id/et_password").exists():
        doInputPassword()      
    resultScenario = poco("com.thinkhome.v3:id/setting_hide_pattern").child("android.widget.RelativeLayout").child("com.thinkhome.v3:id/value").get_text()
...
try:
    ...
    poco(text="灯光").click()
    state = poco("com.thinkhome.v3:id/scroll").child("android.widget.RelativeLayout")[0].child("com.thinkhome.v3:id/tv_status").get_text()
